...
//결국에는 어떤게 먼저 실행되거 어떤게 나중에 실행되는지 캐치를 할수 있어야함.
//그래서 이걸 해결하기 위해서 나오게 된게 promise
//promise : 비동기 프로그래밍을 할 수 있게 해주며, 위에서 언급된 콜백지옥을 어느정도 탈출할수있게 만들어주는 것
//promise 는 콜백함수를 다시 부르겠다는 것.
